...
const Section = ({ id, title, text, img, reverse, children }) => (
  <section
    ...
    } items-center justify-between max-w-[95rem] w-full mx-auto my-6 px-6 sm:px-8 md:px-12 py-12 bg-gray-100  gap-6 md:gap-8 shadow-md`}
  >
    {children ? (
      children
    ) : (
      <>
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <p className="text-base sm:text-lg md:text-lg lg:text-xl leading-relaxed text-gray-700">
            {text}
          </p>
        </div>
    ...
    <Layout>
      ...
      <Section id="home">
        <div className="flex flex-col items-center justify-center w-full">
          <div className="flex flex-wrap justify-center gap-4 sm:gap-8 md:gap-12 mb-8 font-extrabold text-sm sm:text-base md:text-lg uppercase tracking-wider text-black">
          ...
          <h1 className="font-black text-[18vw] sm:text-[15vw] md:text-[12vw] lg:text-[10vw] xl:text-[10rem] leading-none mb-6 sm:mb-8 text-center text-[#00D4FF] tracking-wide">
            RONIX
          </h1>
          ...
          <div
            className="mt-12 sm:mt-16 flex flex-col items-center text-xs sm:text-sm uppercase tracking-widest text-black cursor-pointer"
