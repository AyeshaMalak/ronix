...
const Portfolio = () => {
  ...
  const portfolioItems = [
    ...
    { id: 2, title: "Website Design", shortDesc: "Responsive & modern", image: "/section2.png",
  ...
  return (
    <Layout>
      <div className="px-6 md:px-24 py-10 pt-12">

      
        <h1 className="text-3xl md:text-5xl font-extrabold mb-10 text-center text-[#00D4FF]">
          OUR WORK
        </h1>
              ...
              >
                ...
                {isMobile ? (
                  <div className="px-4 py-3 text-center">
                    <h2 className="text-lg font-extrabold mb-1 text-[#00D4FF]">
                      {item.title}
                    </h2>
